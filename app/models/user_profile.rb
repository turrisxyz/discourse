...
class UserProfile < ActiveRecord::Base
  ...
  after_save do
    if saved_change_to_profile_background_upload_id? || saved_change_to_card_background_upload_id?
      ...
      UploadReference.create!(upload_id: self.profile_background_upload_id, target: self) if self.profile_background_upload_id.present?
      UploadReference.create!(upload_id: self.card_background_upload_id, target: self) if self.card_background_upload_id.present?
    end
  end
